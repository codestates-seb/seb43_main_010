...
const data = {
  allFeed: [
    ...
    },
    {
      ...
      userId: 2,
      nickname: `이름모를새`,
      content: `1995년 12월 30일 대구광역시 서구에서 2남 1녀 중 첫째(장남)로 태어났다. 대구에서 태어나고 자랐으며, 초등학교 6학년이 될 무렵 경상남도
      거창으로 전학을 가 거창에서 초등학교와 중학교를 졸업했다. 이후 고향인 대구로 돌아와 고등학교를 다니던 중 빅히트의 연습생으로 발탁되어 1학년
      2학기에 서울로 상경했다. 빅히트 입사는 2011년 9월이었다. 대구지역 오디션에 참가하는 친구를 따라 구경갔다가 잘생긴 얼굴이 빅히트 관계자의
      눈에 띄어 그 자리에서 오디션 권유를 받았다고 한다. 정작 친구는 탈락하고 뷔만 대구에서 유일하게 합격했다. 이후 회사에 입사하여 1년 반이 조금
      넘는 연습생 생활 끝에 2013년 6월 13일, 지금의 방탄소년단 뷔로 데뷔하였다. 투표에 의한 타이틀 뿐만 아니라 각 분야 전문가와 매체에서 선정하는
      순위에서도 뷔는 독보적이다. 30여개 국가의 전문 사진작가, 디자이너, 메이크업 아티스트, 스타일리스트, 에디터 등 350명의 전문가들이 심사에
      참여한 <2018 Fashion Face Award>에서도 1위에 올라 패션계에서도 최고의 얼굴로 인정받았다. 당시 심사위원들은 12000장이 넘는 사진과
      비디오를 검토하고 여러 전반적인 기준을 고려, 순위를 정하는 데 무려 3개월이 걸렸다고 밝혔다. '더 월드 리스트'의 'The 100 Men In
      Fashion World 2020'에서도 해리 스타일스, 저스틴 비버, 크리스 햄스워스 등 쟁쟁한 해외 스타들을 제치고 1위를 차지, 패션 아이콘으로서의
      위상을 입증했다.`,
      img: { profileImg },
      createdAt: `05. 01. 10:22`,
      feedLikeId: [],
