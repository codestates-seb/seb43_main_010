...
// import { setisLogined } from '../../../reducer/userSlice';
...
//         return;
//       }
//       // await createUserWithEmailAndPassword(authService, fanUser.email, fanUser.password)
//       //   .then((userCredential) => {
//       //     //가입후 자동으로 로그인이 되버리네
//       //     updateProfile(auth.currentUser, { displayName: fanUser.nickname, photoURL: fanUser.profile });
//       //   })
//       //   .then((userCredential) => {
//       //     //여기서 계정 생성 후 계정 정보를 전역변수에 담아줌
